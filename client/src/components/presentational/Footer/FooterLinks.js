...
const FooterLinks = ({t}) => {
    return (
        <Box direction="row" wrap pad="medium">
            ...
            <Box width="33%"><Link to="/our-coffee" style={{'fontSize': '12px'}}>{t("footer.menu.our-coffee")}</Link></Box>
            ...
            <Box width="33%"><Link to="" style={{'fontSize': '12px'}}>{t("footer.menu.brewing")}</Link></Box>
            <Box width="33%"><Link to="" style={{'fontSize': '12px'}}>{t("footer.menu.privacy")}</Link></Box>
        </Box>
    );
};
